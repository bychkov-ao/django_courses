...
def create_view(request):
    ...
    # myself = GamerModel(email="AAAadmin@admin.com",
    #                     nickname="SSSSomeRandomNicknameSave")
    # myself.save()
    # #
    ...
    # ])
    #
    # my_library = GamerLibraryModel(gamer=GamerModel.objects.get(pk=5),
    #                                size=10)
    # my_library.save()
    # my_library.game.set([GameModel.objects.get(pk=6),
    #                      GameModel.objects.get(pk=7)])
    #
